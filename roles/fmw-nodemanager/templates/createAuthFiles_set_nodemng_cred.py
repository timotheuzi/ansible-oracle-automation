...
set('JNDINames',jarray.array([String('jdbc/inv_db_mobile')], String))
...
#create INSPY_CONFIG DS
edit()

startEdit()
cd('/')
cmo.createJDBCSystemResource('INSPY_CONFIG')

cd('/JDBCSystemResources/INSPY_CONFIG/JDBCResource/INSPY_CONFIG')
cmo.setName('INSPY_CONFIG')

cd('/JDBCSystemResources/INSPY_CONFIG/JDBCResource/INSPY_CONFIG/JDBCDataSourceParams/INSPY_CONFIG')
set('JNDINames',jarray.array([String('jdbc/INSPY_CONFIG')], String))

cd('/JDBCSystemResources/INSPY_CONFIG/JDBCResource/INSPY_CONFIG/JDBCDriverParams/INSPY_CONFIG')
#cmo.setUrl('jdbc:oracle:thin:@192.168.0.38:1521:xe')
#cmo.setDriverName('oracle.jdbc.xa.client.OracleXADataSource')
cmo.setUrl(dsURL)
...
cd('/JDBCSystemResources/INSPY_CONFIG/JDBCResource/INSPY_CONFIG/JDBCConnectionPoolParams/INSPY_CONFIG')
cmo.setTestTableName('SQL SELECT 1 FROM DUAL\r\n')

cd('/JDBCSystemResources/INSPY_CONFIG/JDBCResource/INSPY_CONFIG/JDBCDriverParams/INSPY_CONFIG/Properties/INSPY_CONFIG')
cmo.createProperty('user')

cd('/JDBCSystemResources/INSPY_CONFIG/JDBCResource/INSPY_CONFIG/JDBCDriverParams/INSPY_CONFIG/Properties/INSPY_CONFIG/Properties/user')
cmo.setValue('inspy_ap')

cd('/JDBCSystemResources/INSPY_CONFIG/JDBCResource/INSPY_CONFIG/JDBCDataSourceParams/INSPY_CONFIG')
cmo.setGlobalTransactionsProtocol('TwoPhaseCommit')

cd('/SystemResources/INSPY_CONFIG')
set('Targets',jarray.array([ObjectName('com.bea:Name=iui_server1,Type=Server')], ObjectName))
save()
activate()
